  ...
  return (
    <section className="bg-white py-20">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 px-6 items-start">
        ...
        <div>
          <h1 className="text-4xl md:text-5xl font-bold text-dark mb-6 animate-slide-text">
        ...
        <div className="bg-gray-50 rounded-2xl shadow-lg p-8">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center pt-2">
              <button
                type="submit"
                className="bg-primary-gradient text-white px-8 py-3 rounded-full font-semibold hover:opacity-90 active:scale-95 transition disabled:opacity-60 disabled:cursor-not-allowed"
