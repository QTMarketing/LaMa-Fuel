        ...
        <>
            ...
            <motion.div
                ...
                className="fixed inset-0 w-full min-h-screen sm:h-[90vh] md:h-[600px] backdrop-blur-lg 
                          ...
                          rounded-none sm:rounded-lg md:rounded-xl overflow-hidden z-[101]"
...
const InteractiveBentoGallery: React.FC<InteractiveBentoGalleryProps> = ({ mediaItems, title, description }) => {
    ...
    const [hoveredItem, setHoveredItem] = useState<MediaItemType | null>(null);

    const [hoverPosition, setHoverPosition] = useState<{ x: number; y: number; positionAbove: boolean } | null>(null);
    ...
    return (
        ...
        <div className="container mx-auto px-4 py-8 max-w-7xl relative overflow-visible">

            <div className="mb-8 text-center">

                <motion.h1

                    className="text-[26px] sm:text-[34px] md:text-[42px] font-bold bg-clip-text text-transparent 
                        ...
                        {items.map((item, index) => (
                            ...
                            <motion.div
                                ...
                                onMouseEnter={(e) => {
                                    ...
                                    const gap = 20;
                                    const sectionTopOffset = 100; // Account for title/header space
                                    const spaceAbove = rect.top - containerRect.top - sectionTopOffset;
                                    const spaceBelow = containerRect.bottom - rect.bottom;
                                    
                                    // Position above if there's enough space within section, otherwise below
                                    const positionAbove = spaceAbove >= popupHeight + gap;
                                ...
                                onClick={() => !isDragging && router.push('/projects')}
                ...
                {hoveredItem && hoverPosition && (
                    <motion.div
                        ...
                        style={{ 
                            ...
                            transform: hoverPosition.positionAbove 
